...
RSpec.describe 'api/reservations', type: :request do
  path '/api/users/{user_id}/doctors/{doctor_id}/reservations' do
  ...
  path '/api/users/{user_id}/doctors/{doctor_id}/reservations/new' do
    # You'll want to customize the parameter types...
    parameter name: 'user_id', in: :path, type: :string, description: 'user_id'
    parameter name: 'doctor_id', in: :path, type: :string, description: 'doctor_id'
  ...
  path '/api/users/{user_id}/doctors/{doctor_id}/reservations/{id}' do
    # You'll want to customize the parameter types...
    parameter name: 'user_id', in: :path, type: :string, description: 'user_id'
    parameter name: 'doctor_id', in: :path, type: :string, description: 'doctor_id'
